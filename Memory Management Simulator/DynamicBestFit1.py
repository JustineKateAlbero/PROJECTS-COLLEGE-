...
root = Tk()
root.title ( "DYNAMIC BEST FIT PARTITION ALLOCATION" )
#
...
class dynamic_bestFit_frontEnd:
    ...
    def displayMap( self, tempPointer, tempColor, tempText, tempPercentage, tempTotalSize ):
        ...
        for i in range( int( self.tempPercentage / 2 ) ):
            if self.tempPointer != 0:
                ...
                pass
        if self.tempPercentage != 0:
            self.tempLBL  =  Label( root , text = tempTotalSize , font = ('Poppins', 10),  bg = "#c6e3ad")
    ...
    def input1_window( self ):
        ...
        self.topper = Label(root, image=image_best, borderwidth="0", highlightthickness="0", relief="flat",
                            activebackground="black", background="black")
        ...
        self.compactionMenu.configure( width = 20, height=1, bg="#ecd3bf", font=('Poppins', 16, 'bold'), borderwidth=5, relief="sunken" )
        self.compactionMenu['menu'].config(font=('Poppins', 14), bg="#eec894", relief="flat")
        self.compactionMenu.place( x = 305, y = 650 )

        self.computeBTN  =  Button ( root , text = 'Compute',command = self.input1_computeBTN_Pressed , font=('Poppins', 16, 'bold'),
    ...
    def summaryTable_window( self ):
        ...
        self.memSizeDisplay = Label(root, text = self.memSize, width = 10, font=('Poppins', 13, 'bold'), justify="center", bg="#eec894")
        self.memSizeDisplay.place(x=210, y=110)
        self.basicWidgetList.append(self.memSizeDisplay)

        self.osSizeDisplay = Label(root, text = self.osSize,  width = 10,  font=('Poppins', 13, 'bold'), justify="center", bg="#eec894")
        ...
        self.topper1 = Label(root, image=image_best, borderwidth="0", highlightthickness="0", relief="flat", activebackground="black", background="black")
        ...
        self.nextBTN  =  Button ( root , text = 'NEXT',command = self.summaryTable_nextBTN_Pressed , font = ('Poppins', 16, 'bold'), width  =  12, bg="#f77f00",  height=1, borderwidth=5, relief="sunken")
        self.nextBTN.place(x=680, y=650)
        self.basicWidgetList.append( self.nextBTN )
        
        self.exitBTN  =  Button ( root , text = 'Exit',command = self.homepage , font = ('Poppins', 16, 'bold'), width  =  12,  bg="#eae2b7", height=1, borderwidth=5, relief="sunken")
...
class dynamic_bestFitNode_frontEnd:
    ...
    def displayMap( self, tempPointer, tempColor, tempText, tempPercentage, tempTotalSize ):
        ...
        for i in range( int( self.tempPercentage / 2 ) ):
            if self.tempPointer != 0:
                ...
                pass
        if self.tempPercentage != 0:
            self.tempLBL  =  Label( root , text = tempTotalSize , font = ('Poppins', 10),  bg = "#E8C39E", relief = "ridge", width = 5)
    ...
    def memMap_window( self ):
        ...
        self.partitionLBL  =  Label( root , text = "Number" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised", borderwidth=2, width=7)
        self.partitionLBL.place(x = 460, y = 160)
        self.basicWidgetList.append( self.partitionLBL )

        self.partition1LBL  =  Label( root , text = "1" , font = ('Poppins', 15),  bg = self.memMap_data2[0][1],  relief = "groove", width = 7)
        self.partition1LBL.place(x = 460, y = 210)
        self.basicWidgetList.append( self.partition1LBL )
        
        self.partition2LBL  =  Label( root , text = "2" , font = ('TPoppins', 15),  bg = self.memMap_data2[1][1],  relief = "groove", width = 7)
        self.partition2LBL.place(x = 460, y = 260)
        self.basicWidgetList.append( self.partition2LBL )
        
        self.partition3LBL  =  Label( root , text = "3" , font = ('Poppins', 15),  bg = self.memMap_data2[2][1],  relief = "groove", width = 7)
        self.partition3LBL.place(x = 460, y = 310)
        self.basicWidgetList.append( self.partition3LBL )
        
        self.partition4LBL  =  Label( root , text = "4" , font = ('TPoppins', 15),  bg = self.memMap_data2[3][1],  relief = "groove", width = 7)
        self.partition4LBL.place(x = 460, y = 360)
        self.basicWidgetList.append( self.partition4LBL )
        
        self.partition5LBL  =  Label( root , text = "5" , font = ('TPoppins', 15),  bg = self.memMap_data2[4][1],  relief = "groove", width = 7)
        self.partition5LBL.place(x = 460, y = 410)
        self.basicWidgetList.append( self.partition5LBL )

        self.partition6LBL  =  Label( root , text = "6" , font = ('Poppins', 15),  bg = self.memMap_data2[5][1],  relief = "groove", width = 7)
        self.partition6LBL.place(x = 460, y = 460)
        self.basicWidgetList.append( self.partition6LBL )
        
        self.partition7LBL  =  Label( root , text = "7" , font = ('Poppins', 15),  bg = self.memMap_data2[6][1],  relief = "groove", width = 7)
        self.partition7LBL.place(x = 460, y = 510)
        self.basicWidgetList.append( self.partition7LBL )


        # Size Widgets
        self.sizeLBL  =  Label( root , text = "Size" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=12)
        ...
        # Status Widgets
        self.statusLBL  =  Label( root , text = "Status" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14)
    ...
    def pat_window( self ):
        ...
        self.title3LBL  =  Label( root , text = "Partition Allocation Table" , font = ('Poppins', 15, 'bold'), height=1, width=74, borderwidth=5, relief="groove", bg = "#e8dcb5")
        self.title3LBL.place(x = 0, y = 60)
        self.basicWidgetList.append( self.title3LBL )
        ...
        # PAT Number Widgets
        self.patNumLBL  =  Label( root , text = "Partition No." , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=12)
        ...
        # PAT Size Widgets
        self.patSizeLBL  =  Label( root , text = "Size" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
        ...
        self.patLocationLBL  =  Label( root , text = "Location" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
        ...
        # PAT Status Widgets
        self.patStatusLBL  =  Label( root , text = "Status" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
    ...
    def fat_window( self ):
        ...
        # fat Size Widgets
        self.fatSizeLBL  =  Label( root , text = "Size" ,font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
        ...
        self.fatLocationLBL  =  Label( root , text = "Location" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
        ...
        # fat Status Widgets
        self.fatStatusLBL  =  Label( root , text = "Status" , font = ('Poppins', 15),  bg = "#FFB448", relief = "raised",  borderwidth=2, width=14, justify="center")
